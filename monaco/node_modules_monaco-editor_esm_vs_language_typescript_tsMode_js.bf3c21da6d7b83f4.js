"use strict";
(self["webpackChunkiris"] = self["webpackChunkiris"] || []).push([["node_modules_monaco-editor_esm_vs_language_typescript_tsMode_js"],{
...
/* harmony export */ });
/* harmony import */ var C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 669);
/* harmony import */ var _editor_editor_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../editor/editor.api.js */ 1809);
/* harmony import */ var _monaco_contribution_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./monaco.contribution.js */ 1906);
...
var WorkerManager = class {
  ...
  _updateExtraLibs() {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const myToken = ++_this._updateExtraLibsToken;
      const proxy = yield _this._worker.getProxy();
...
var LibFiles = class {
  ...
  getOrCreateModel(fileName) {
    ...
    const matchedLibFile = _monaco_contribution_js__WEBPACK_IMPORTED_MODULE_2__.typescriptDefaults.getExtraLibs()[fileName];
    if (matchedLibFile) {
  ...
  fetchLibFilesIfNecessary(uris) {
    var _this2 = this;
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this2._containsLibFile(uris)) {
        return;
      }
      yield _this2._fetchLibFiles();
    })();
  }
  _fetchLibFiles() {
...
var DiagnosticsAdapter = class extends Adapter {
  ...
  _doValidate(model) {
    var _this3 = this;
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const worker = yield _this3._worker(model.uri);
      if (model.isDisposed()) {
        return;
      }
      const promises = [];
      ...
      } = _this3._defaults.getDiagnosticsOptions();
      ...
      const diagnostics = allDiagnostics.reduce((p, c) => c.concat(p), []).filter(d => (_this3._defaults.getDiagnosticsOptions().diagnosticCodesToIgnore || []).indexOf(d.code) === -1);
      ...
      yield _this3._libFiles.fetchLibFilesIfNecessary(relatedUris);
      if (model.isDisposed()) {
        return;
      }
      monaco_editor_core_exports.editor.setModelMarkers(model, _this3._selector, diagnostics.map(d => _this3._convertDiagnostics(model, d)));
    })();
  }
...
var SuggestAdapter = class extends Adapter {
  ...
  provideCompletionItems(model, position, _context, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const worker = yield _this4._worker(resource);
      if (model.isDisposed()) {
        return;
      }
  ...
  resolveCompletionItem(item, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const worker = yield _this5._worker(resource);
...
var SignatureHelpAdapter = class extends Adapter {
  ...
  provideSignatureHelp(model, position, token, context) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const offset = model.getOffsetAt(position);
      const worker = yield _this6._worker(resource);
      if (model.isDisposed()) {
        return;
      }
...
var QuickInfoAdapter = class extends Adapter {
  provideHover(model, position, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const offset = model.getOffsetAt(position);
      const worker = yield _this7._worker(resource);
      if (model.isDisposed()) {
        return;
      }
      ...
      return {
        range: _this7._textSpanToRange(model, info.textSpan),
        contents: [{
          value: "```typescript\n" + contents + "\n```\n"
        }, {
...
var OccurrencesAdapter = class extends Adapter {
  provideDocumentHighlights(model, position, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const offset = model.getOffsetAt(position);
      const worker = yield _this8._worker(resource);
      if (model.isDisposed()) {
        return;
      }
...
var DefinitionAdapter = class extends Adapter {
  ...
  provideDefinition(model, position, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const offset = model.getOffsetAt(position);
      const worker = yield _this9._worker(resource);
      if (model.isDisposed()) {
        return;
      }
      ...
      yield _this9._libFiles.fetchLibFilesIfNecessary(entries.map(entry => monaco_editor_core_exports.Uri.parse(entry.fileName)));
      if (model.isDisposed()) {
        return;
      }
      const result = [];
      for (let entry of entries) {
        const refModel = _this9._libFiles.getOrCreateModel(entry.fileName);
        if (refModel) {
          result.push({
            uri: refModel.uri,
            range: _this9._textSpanToRange(refModel, entry.textSpan)
          });
        }
      }
      return result;
...
var ReferenceAdapter = class extends Adapter {
  ...
  provideReferences(model, position, context, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const offset = model.getOffsetAt(position);
      const worker = yield _this10._worker(resource);
      if (model.isDisposed()) {
        return;
      }
      ...
      yield _this10._libFiles.fetchLibFilesIfNecessary(entries.map(entry => monaco_editor_core_exports.Uri.parse(entry.fileName)));
      if (model.isDisposed()) {
        return;
      }
      const result = [];
      for (let entry of entries) {
        const refModel = _this10._libFiles.getOrCreateModel(entry.fileName);
        if (refModel) {
          result.push({
            uri: refModel.uri,
            range: _this10._textSpanToRange(refModel, entry.textSpan)
          });
        }
      }
      return result;
...
var OutlineAdapter = class extends Adapter {
  provideDocumentSymbols(model, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const worker = yield _this11._worker(resource);
      if (model.isDisposed()) {
        return;
      }
...
var FormatAdapter = class extends FormatHelper {
  provideDocumentRangeFormattingEdits(model, range, options, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const worker = yield _this12._worker(resource);
      if (model.isDisposed()) {
        return;
      }
      ...
      return edits.map(edit => _this12._convertTextChanges(model, edit));
    })();
  }
};
var FormatOnTypeAdapter = class extends FormatHelper {
  ...
  provideOnTypeFormattingEdits(model, position, ch, options, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const resource = model.uri;
      const offset = model.getOffsetAt(position);
      const worker = yield _this13._worker(resource);
      if (model.isDisposed()) {
        return;
      }
      ...
      return edits.map(edit => _this13._convertTextChanges(model, edit));
    })();
  }
};
var CodeActionAdaptor = class extends FormatHelper {
  provideCodeActions(model, range, context, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const worker = yield _this14._worker(resource);
      if (model.isDisposed()) {
        return;
      }
...
var RenameAdapter = class extends Adapter {
  ...
  provideRenameEdits(model, position, newName, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const offset = model.getOffsetAt(position);
      const worker = yield _this15._worker(resource);
      if (model.isDisposed()) {
        return;
      }
      ...
      for (const renameLocation of renameLocations) {
        const model2 = _this15._libFiles.getOrCreateModel(renameLocation.fileName);
        if (model2) {
          edits.push({
            resource: model2.uri,
            edit: {
              range: _this15._textSpanToRange(model2, renameLocation.textSpan),
              text: newName
            }
          });
        } else {
...
var InlayHintsAdapter = class extends Adapter {
  provideInlayHints(model, range, token) {
    ...
    return (0,C_git_iris_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const worker = yield _this16._worker(resource);
      if (model.isDisposed()) {
        return null;
      }
